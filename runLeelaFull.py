...
xDebian10.addJob("Round Zero",            "gfortran", "Release", "-ROUND_NEAR ROUND_ZERO",  None)
...
xDebian10.addJob("Round Zero",            "gfortran", "Debug",   "-ROUND_NEAR ROUND_ZERO",  None)
...
xDebian10.addJob("Round Zero",            "ifort",    "Release", "-ROUND_NEAR ROUND_ZERO",  None)
...
xDebian10.addJob("Round Zero",            "ifort",    "Debug",   "-ROUND_NEAR ROUND_ZERO",  None)
...
xDebian10.addJob("Round Zero",            "nagfor",   "Release", "-ROUND_NEAR ROUND_ZERO",  None)
...
xDebian10.addJob("Round Zero",            "nagfor",   "Debug",   "-ROUND_NEAR ROUND_ZERO",  None)
